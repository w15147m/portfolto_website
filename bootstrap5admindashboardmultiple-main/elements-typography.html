...
<html lang="en">
  <head>
    ...
    <title>JassaRich - Typography</title>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-2xl">
              ...
              <div class="mt-5 flex flex-col space-y-3">
                <p>
                  <span class="bg-gradient-to-r from-sky-400 to-blue-600 bg-clip-text text-lg font-semibold text-transparent">
                    The quick brown fox jumps over the lazy dog.
                  </span>
                </p>
                <p>
                  <span class="bg-gradient-to-r from-green-400 to-fuchsia-400 bg-clip-text text-lg font-semibold text-transparent">
                    The quick brown fox jumps over the lazy dog.
                  </span>
                </p>
                <p>
                  <span class="bg-gradient-to-r from-fuchsia-600 to-pink-600 bg-clip-text text-lg font-semibold text-transparent">
                    The quick brown fox jumps over the lazy dog.
                  </span>
                </p>
                <p>
                  <span class="bg-gradient-to-r from-amber-400 to-orange-600 bg-clip-text text-lg font-semibold text-transparent">
                    The quick brown fox jumps over the lazy dog.
                  </span>
                </p>
              </div>
            ...
            <div class="max-w-2xl">
              ...
              <div class="mt-5">
                <p class="text-sm leading-6">
                  ...
                  build X-Wings at
                  <a href="#" class="font-semibold underline decoration-info decoration-2">My Company, Inc</a>. Outside of work, I like to
                  <a href="#" class="font-semibold underline decoration-secondary decoration-2">watch pod-racing</a>
                  and have
                  <a href="#" class="font-semibold underline decoration-primary decoration-2">light-saber</a>
                  fights.
                </p>
              </div>
            </div>
            ...
            <div class="max-w-2xl">
              ...
              <div class="mt-5">
                <p class="text-sm leading-6">
                  ...
                  <a href="#" class="font-semibold underline decoration-info decoration-wavy decoration-2">
                    Tattooine </a>. I like to build X-Wings at
                  <a href="#" class="font-semibold underline decoration-info decoration-double decoration-2">My Company, Inc</a>. Outside of work, I like to
                  <a href="#" class="font-semibold underline decoration-secondary decoration-dotted decoration-2">watch pod-racing</a>
                  and have
                  <a href="#" class="font-semibold underline decoration-primary decoration-dashed decoration-2">light-saber</a>
                  fights.
                </p>
              </div>
            </div>
