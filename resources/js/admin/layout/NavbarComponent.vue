                    ...
                    <div class="tab-content flex flex-col overflow-hidden">
                      ...
                      <div x-show="activeTab === 'tabLogs'" x-transition:enter="transition-all duration-300 easy-in-out"
                        ...
                        <div class="mt-8 pb-8 text-center">
                          <!-- <img class="mx-auto w-36" src="{{ asset('admin/images/illustrations/empty-girl-box.svg') }}" alt="image"> -->
                          <div class="mt-5">
          ...
          <div x-data="{activeTab:'tabHome'}"
                ...
                <div class="swiper mt-3 px-3"
                  ...
                  <div class="swiper-wrapper">
                    <div
                      ...
                      <div class="grow">
                        <!-- <img class="h-3" src="{{ asset('admin/images/payments/cc-visa-white.svg') }}" alt="image"> -->
                      </div>
              ...
              <div class="mt-4">
                ...
                <div class="mt-3 grid grid-cols-2 gap-3 px-3">
                  <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                    <div class="flex items-center space-x-2">
                      <!-- <img class="size-10" src="{{ asset('admin/images/logos/bitcoin.svg') }}" alt="image"> -->
                      <div>
                  ...
                  <div class="rounded-lg bg-slate-100 p-2.5 dark:bg-navy-600">
                    <div class="flex items-center space-x-2">
                      <!-- <img class="size-10" src="{{ asset('admin/images/logos/solana.svg')}}" alt="image"> -->
                      <div>
                        <h2 class="font-medium tracking-wide text-slate-700 dark:text-navy-100">
                          SOL
                        </h2>
              ...
              <div class="mt-4">
                ...
                <div class="mt-3 space-y-3 px-2">
                  <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                      ...
                      <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                          <div class="avatar h-7 w-7">
                            <!-- <img class="rounded-full" src="{{ asset('admin/images/avatar/avatar-20')}}.jpg" alt="avatar"> -->
                          </div>
                          <div>
                    ...
                    <!-- <img src="{{ asset('admin/images/object/object-18')}}.jpg" class="size-20 rounded-lg object-cover object-center" -->
                      alt="image">
                  </div>
                  ...
                  <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                    <div class="flex flex-1 flex-col justify-between">
                      ...
                      <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                          <div class="avatar h-7 w-7">
                            <!-- <img class="rounded-full" src="{{ asset('admin/images/avatar/avatar-19')}}.jpg" alt="avatar"> -->
                          </div>
                          <div>
                            <p class="text-xs font-medium line-clamp-1">
                              Travis F.
                    ...
                    <!-- <img src="{{ asset('admin/images/object/object-2')}}.jpg" class="size-20 rounded-lg object-cover object-center" -->
                      alt="image">
                  </div>
                  ...
                  <div class="flex justify-between space-x-2 rounded-lg bg-slate-100 p-2.5 dark:bg-navy-700">
                    <div class="flex flex-1 flex-col justify-between">
                      ...
                      <div class="flex items-center justify-between">
                        <div class="flex items-center space-x-2">
                          <div class="avatar h-7 w-7">
                            <!-- <img class="rounded-full" src="{{ asset('admin/images/avatar/avatar-18')}}.jpg" alt="avatar"> -->
                          </div>
                          <div>
                            <p class="text-xs font-medium line-clamp-1">
                              Alfredo E .
                    ...
                    <!-- <img src="{{ asset('admin/images/object/object-1')}}.jpg" class="size-20 rounded-lg object-cover object-center" -->
                      alt="image">
                  </div>
                </div>
              </div>
            ...
            <div x-show="activeTab === 'tabProjects'" x-transition:enter="transition-all duration-500 easy-in-out"
              ...
              <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                <div class="flex items-center space-x-3">
                  <!-- <img class="size-10 rounded-lg object-cover object-center" src="{{ asset('admin/images/illustrations/lms-ui')}}.svg" -->
                    alt="image">
                  <div>
              ...
              <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                <div class="flex items-center space-x-3">
                  <!-- <img class="size-10 rounded-lg object-cover object-center" src="{{ asset('admin/images/illustrations/store-ui')}}.svg" -->
                    alt="image">
                  <div>
                    <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                      Store Dashboard
                ...
                <div class="mt-3 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    <div class="avatar h-7 w-7 hover:z-10">
                      <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-17')}}.jpg" -->
                        alt="avatar">
                    </div>
                    <div class="avatar h-7 w-7 hover:z-10">
                      <div
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-19')}}.jpg" -->
                        alt="avatar">
                    </div>
                  </div>
                  <button
              ...
              <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                <div class="flex items-center space-x-3">
                  <!-- <img class="size-10 rounded-lg object-cover object-center" src="{{ asset('admin/images/illustrations/chat-ui')}}.svg" -->
                    alt="image">
                  <div>
                    <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                      Chat Mobile App
              ...
              <div class="mt-4 rounded-lg border border-slate-150 p-3 dark:border-navy-600">
                <div class="flex items-center space-x-3">
                  <!-- <img class="size-10 rounded-lg object-cover object-center" src="{{ asset('admin/images/illustrations/nft.svg')}}" -->
                    alt="image">
                  <div>
                    <p class="font-medium leading-snug text-slate-700 dark:text-navy-100">
                      NFT Marketplace App
                ...
                <div class="mt-3 flex items-center justify-between space-x-2">
                  <div class="flex -space-x-3">
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-12')}}.jpg" -->
                        alt="avatar">
                    </div>
                  </div>
                  <button
                ...
                <li class="timeline-item">
                  ...
                  <div class="timeline-item-content flex-1 pl-4">
                    ...
                    <div class="mt-4 grid grid-cols-3 gap-3">
                      <!-- <img class="rounded-lg" src="{{ asset('admin/images/object/object-1.jpg')}}" alt="image"> -->
                      <!-- <img class="rounded-lg" src="{{ asset('admin/images/object/object-2.jpg')}}" alt="image"> -->
                      <!-- <img class="rounded-lg" src="{{ asset('admin/images/object/object-3.jpg')}}" alt="image"> -->
                      <!-- <img class="rounded-lg" src="{{ asset('admin/images/object/object-4.jpg')}}" alt="image"> -->
                      <!-- <img class="rounded-lg" src="{{ asset('admin/images/object/object-5.jpg')}}" alt="image"> -->
                      <!-- <img class="rounded-lg" src="{{ asset('admin/images/object/object-6.jpg')}}" alt="image"> -->
                    </div>
                    <div class="mt-4">
