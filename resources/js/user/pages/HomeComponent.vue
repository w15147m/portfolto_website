<template>
    <div
      class="w-100 mt-4 grid grid-cols-12 gap-4 px-[var(--margin-x)] transition-all duration-[.25s] sm:mt-5 sm:gap-5 lg:mt-6 lg:gap-6">
              ...
              <div class="mt-8 flex items-center justify-between space-x-2">
                <div class="flex -space-x-3">
                  <div class="avatar size-8 hover:z-10">
                    <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-16.jpg')}}" -->
                      alt="avatar">
                  </div>
                  <div class="avatar size-8 hover:z-10">
                    <div
                  ...
                  <div class="avatar size-8 hover:z-10">
                    <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-20.jpg')}}" -->
                      alt="avatar">
                  </div>
                </div>
                <button
            ...
            <div>
              ...
              <div class="mt-8 flex items-center justify-between space-x-2">
                <div class="flex -space-x-3">
                  ...
                  <div class="avatar size-8 hover:z-10">
                    <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-14.jpg')}}" -->
                      alt="avatar">
                  </div>
                </div>
                <button
          ...
          <div class="flex flex-col justify-between border-4 border-transparent border-l-warning px-4">
            ...
            <div>
              ...
              <div class="mt-8 flex items-center justify-between space-x-2">
                <div class="flex -space-x-3">
                  <div class="avatar size-8 hover:z-10">
                    <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-11.jpg')}}" -->
                      alt="avatar">
                  </div>
                  <div class="avatar size-8 hover:z-10">
                    <div
                  ...
                  <div class="avatar size-8 hover:z-10">
                    <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-10.jpg')}}" -->
                      alt="avatar">
                  </div>
                </div>
                <button
      ...
      <div
        ...
        <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
          <div class="flex items-center justify-between space-x-2">
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <!-- <img class="mask is-squircle" src="{{ asset('admin/images/avatar/avatar-5.jpg')}}" alt="image"> -->
              </div>
              <div>
          ...
          <div class="flex justify-between">
            <div class="flex space-x-2">
              <!-- <img x-tooltip="'Award Level 1'" class="size-6" src="{{ asset('admin/images/awards/award-19.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('admin/images/awards/award-2.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('admin/images/awards/award-5.svg')}}" alt="avatar"> -->
            </div>
            <button
        ...
        <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
          <div class="flex items-center justify-between space-x-2">
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <!-- <img class="mask is-squircle" src="{{ asset('admin/images/avatar/avatar-18.jpg')}}" alt="image"> -->
              </div>
              <div>
                <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                  Konnor Guzman
          ...
          <div class="flex justify-between">
            <div class="flex space-x-2">
              <!-- <img x-tooltip="'Award Level 1'" class="size-6" src="{{ asset('admin/images/awards/award-1.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('admin/images/awards/award-6.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('admin/images/awards/award-9.svg')}}" alt="avatar"> -->
            </div>
            <button
              class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24"
        ...
        <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
          <div class="flex items-center justify-between space-x-2">
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <!-- <img class="mask is-squircle" src="{{ asset('admin/images/avatar/avatar-6.jpg')}}" alt="image"> -->
              </div>
              <div>
                <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                  Alfredo Elliott
          ...
          <div class="flex justify-between">
            <div class="flex space-x-2">
              <!-- <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('admin/images/awards/award-14.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('admin/images/awards/award-13.svg')}}" alt="avatar"> -->
            </div>
            <button
              class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24"
        ...
        <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
          <div class="flex items-center justify-between space-x-2">
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <!-- <img class="mask is-squircle" src="{{ asset('admin/images/avatar/avatar-11.jpg')}}" alt="image"> -->
              </div>
              <div>
                <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                  Samantha Shelton
          ...
          <div class="flex justify-between">
            <div class="flex space-x-2">
              <!-- <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('admin/images/awards/award-15.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('admin/images/awards/award-13.svg')}}" alt="avatar"> -->
            </div>
            <button
              class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
        ...
        <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
          <div class="flex items-center justify-between space-x-2">
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <!-- <img class="mask is-squircle" src="{{ asset('admin/images/avatar/avatar-19.jpg')}}" alt="image"> -->
              </div>
              <div>
                <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                  Derrick Simmons
          ...
          <div class="flex justify-between">
            <div class="flex space-x-2">
              <!-- <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('admin/images/awards/award-15.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('admin/images/awards/award-5.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('admin/images/awards/award-25.svg')}}" alt="avatar"> -->
            </div>
            <button
              class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24"
        ...
        <div class="card w-72 shrink-0 space-y-9 rounded-xl p-4 sm:px-5">
          <div class="flex items-center justify-between space-x-2">
            <div class="flex items-center space-x-3">
              <div class="avatar">
                <!-- <img class="mask is-squircle" src="{{ asset('admin/images/avatar/avatar-7.jpg')}}" alt="image"> -->
              </div>
              <div>
                <p class="font-medium text-slate-700 line-clamp-1 dark:text-navy-100">
                  Katrina West
          ...
          <div class="flex justify-between">
            <div class="flex space-x-2">
              <!-- <img x-tooltip="'Award Level 2'" class="size-6" src="{{ asset('admin/images/awards/award-1.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('admin/images/awards/award-24.svg')}}" alt="avatar"> -->
              <!-- <img x-tooltip="'Award Level 3'" class="size-6" src="{{ asset('admin/images/awards/award-30.svg')}}" alt="avatar"> -->
            </div>
            <button
              class="btn -mr-1.5 size-8 rounded-full p-0 hover:bg-slate-300/20 focus:bg-slate-300/20 active:bg-slate-300/25 dark:hover:bg-navy-300/20 dark:focus:bg-navy-300/20 dark:active:bg-navy-300/25">
              <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="none" viewbox="0 0 24 24"
          ...
          <li class="timeline-item">
            ...
            <div class="timeline-item-content flex-1 pl-4 sm:pl-8">
              ...
              <div class="avatar mt-2 size-16">
                <!-- <img class="mask is-squircle" src="{{ asset('admin/images/avatar/avatar-19.jpg')}}" alt="avatar"> -->
              </div>
            </div>
          </li>
          <li class="timeline-item">
              ...
              <div>
                ...
                <div class="mt-2 flex justify-between">
                  <div class="flex flex-wrap -space-x-2">
                    ...
                    <div class="avatar h-7 w-7 hover:z-10">
                      <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-8.jpg')}}" -->
                        alt="avatar">
                    </div>

                    <div class="avatar h-7 w-7 hover:z-10">
                      <!-- <img class="rounded-full ring ring-white dark:ring-navy-700" src="{{ asset('admin/images/avatar/avatar-5.jpg')}}" -->
                        alt="avatar">
                    </div>
                  </div>
                  <button
