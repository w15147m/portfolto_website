...
<html lang="en">
  <head>
    ...
    <title>JassaRich - Spinner Element</title>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-2xl">
              ...
              <div class="inline-space mt-5 flex flex-wrap">
                ...
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-secondary border-r-transparent"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-info border-r-transparent"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-success border-r-transparent"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-warning border-r-transparent"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-error border-r-transparent"></div>
              </div>
            </div>
  ...
  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-slate-500 border-r-transparent dark:border-navy-300 dark:border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-primary border-r-transparent dark:border-accent dark:border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-secondary border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-info border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-success border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-warning border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-error border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;</code>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-2xl">
              ...
              <div class="inline-space mt-5 flex flex-wrap">
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-slate-500 border-r-transparent dark:border-navy-300 dark:border-r-transparent"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-primary border-r-transparent dark:border-accent dark:border-r-transparent"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-secondary border-r-transparent"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-info border-r-transparent"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-success border-r-transparent"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-warning border-r-transparent"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-error border-r-transparent"></div>
              </div>
            </div>
  ...
  &lt;div&#13;&#10;    class=&quot;spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-slate-500 border-r-transparent dark:border-navy-300 dark:border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-primary border-r-transparent dark:border-accent dark:border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-secondary border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-info border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-success border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-warning border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-error border-r-transparent&quot;&#13;&#10;  &gt;&lt;/div&gt;</code>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-2xl">
              ...
              <div class="inline-space mt-5 flex flex-wrap">
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-slate-150 border-r-slate-500 dark:border-navy-500 dark:border-r-navy-300"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-secondary/30 border-r-secondary"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-info/30 border-r-info"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-success/30 border-r-success"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-warning/30 border-r-warning"></div>
                <div class="spinner size-7 animate-spin rounded-full border-[3px] border-error/30 border-r-error"></div>
              </div>
            </div>
            <div class="code-wrapper hidden pt-4">
              <pre class="is-scrollbar-hidden max-h-96 overflow-auto rounded-lg" x-init="hljs.highlightElement($el)">
  ...
  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-slate-150 border-r-slate-500 dark:border-navy-500 dark:border-r-navy-300&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-secondary/30 border-r-secondary&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-info/30 border-r-info&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-success/30 border-r-success&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-warning/30 border-r-warning&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;  &lt;div&#13;&#10;    class=&quot;spinner size-7 animate-spin rounded-full border-[3px] border-error/30 border-r-error&quot;&#13;&#10;  &gt;&lt;/div&gt;&#13;&#10;</code>
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-2xl">
              ...
              <div class="inline-space mt-5 flex flex-wrap">
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-slate-150 border-r-slate-500 dark:border-navy-500 dark:border-r-navy-300"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-secondary/30 border-r-secondary"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-info/30 border-r-info"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-success/30 border-r-success"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-warning/30 border-r-warning"></div>
                <div class="spinner is-elastic size-7 animate-spin rounded-full border-[3px] border-error/30 border-r-error"></div>
              </div>
            </div>
            <div class="code-wrapper hidden pt-4">
              <pre class="is-scrollbar-hidden max-h-96 overflow-auto rounded-lg" x-init="hljs.highlightElement($el)">
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div class="max-w-2xl">
              ...
              <div class="inline-space mt-5 flex flex-wrap">
                ...
                <div class="spinner is-grow relative size-7">
                  <span class="absolute inline-block h-full w-full rounded-full bg-secondary opacity-75"></span>
                  <span class="absolute inline-block h-full w-full rounded-full bg-secondary opacity-75"></span>
                </div>
                <div class="spinner is-grow relative size-7">
                ...
                <div class="spinner is-grow relative size-7">
                  <span class="absolute inline-block h-full w-full rounded-full bg-success opacity-75"></span>
                  <span class="absolute inline-block h-full w-full rounded-full bg-success opacity-75"></span>
                </div>
                <div class="spinner is-grow relative size-7">
                  <span class="absolute inline-block h-full w-full rounded-full bg-warning opacity-75"></span>
                  <span class="absolute inline-block h-full w-full rounded-full bg-warning opacity-75"></span>
                </div>
                <div class="spinner is-grow relative size-7">
          ...
          <div class="card px-4 pb-4 sm:px-5">
            ...
            <div>
              ...
              <div class="inline-space flex flex-wrap">
                <!-- Basic Spinner -->
                <div class="inline-space mt-5 flex flex-wrap">
                  <div class="spinner size-5 animate-spin rounded-full border-2 border-primary border-r-transparent dark:border-accent dark:border-r-transparent"></div>
                  <div class="spinner size-7 animate-spin rounded-full border-[3px] border-primary border-r-transparent dark:border-accent dark:border-r-transparent"></div>
                  <div class="spinner size-10 animate-spin rounded-full border-4 border-primary border-r-transparent dark:border-accent dark:border-r-transparent"></div>
                  <div class="spinner size-12 animate-spin rounded-full border-4 border-primary border-r-transparent dark:border-accent dark:border-r-transparent"></div>
                  <div class="spinner size-16 animate-spin rounded-full border-4 border-primary border-r-transparent dark:border-accent dark:border-r-transparent"></div>
                </div>

                <!-- Soft Color Spinner -->
                <div class="inline-space mt-5 flex flex-wrap">
                  <div class="spinner size-5 animate-spin rounded-full border-2 border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent"></div>
                  <div class="spinner size-7 animate-spin rounded-full border-[3px] border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent"></div>
                  <div class="spinner size-10 animate-spin rounded-full border-4 border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent"></div>
                  <div class="spinner size-12 animate-spin rounded-full border-4 border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent"></div>
                  <div class="spinner size-16 animate-spin rounded-full border-4 border-primary/30 border-r-primary dark:border-accent/30 dark:border-r-accent"></div>
                </div>
