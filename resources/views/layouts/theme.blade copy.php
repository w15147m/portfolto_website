...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="{{ asset('PortfolioThemes/css/bootstrap.min.css') }}">
      <link rel="stylesheet" type="text/css" href="{{ asset('PortfolioThemes/css/style.css') }}">
      <link rel="stylesheet" href="{{ asset('PortfolioThemes/css/responsive.css') }}">
      <!-- fevicon -->
      <link rel="icon" href="{{ asset('PortfolioThemes/images/fevicon.png')}}" type="image/gif" />
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="{{ asset('PortfolioThemes/css/jquery.mCustomScrollbar.min.css')}}">
   ...
   <body>
      ...
      <div class="header_section">
         <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <div class="logo"><a href="index.html"><img src="{{ asset('PortfolioThemes/images/logo.png')}}"></a></div>
         ...
         <div class="banner_section layout_padding">
            ...
            <div class="container">
               <div class="video_bt">
                  <div class="play_icon"><img src="{{asset('PortfolioThemes/images/play-icon.png')}}"></div>
               </div>
            </div>
         </div>
         <!-- banner section end -->
            ...
            <div class="services_section_2">
               <div class="row">
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="{{asset('PortfolioThemes/images/icon-4.png')}}"></div>
                        <div class="app_icon_1"><img src="{{asset('PortfolioThemes/images/icon-8.png')}}"></div>
                        <h4 class="services_text active">App Design</h4>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="{{asset('PortfolioThemes/images/icon-5.png')}}"></div>
                        <div class="app_icon_1"><img src="{{asset('PortfolioThemes/images/icon-6.png')}}"></div>
                        <h4 class="services_text">Website Design</h4>
                     </div>
                  </div>
                  <div class="col-lg-3 col-sm-6">
                     <div class="box_main ">
                        <div class="app_icon"><img src="{{asset('PortfolioThemes/images/icon-3.png')}}"></div>
                        <div class="app_icon_1"><img src="{{asset('PortfolioThemes/images/icon-7.png')}}"></div>
            ...
            <div class="portfolio_section">
                  ...
                  <div class="row">
                     <div class="col-md-8">
                        <div class="container_main">
                           <img src="{{asset('PortfolioThemes/images/img-1.png')}}" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="{{asset('PortfolioThemes/images/img-2.png')}}" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
               ...
               <div class="portfolio_section_2">
                  <div class="row">
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="{{asset('PortfolioThemes/images/img-3.png')}}" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="{{asset('PortfolioThemes/images/img-4.png')}}" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
                     ...
                     <div class="col-md-4">
                        <div class="container_main">
                           <img src="{{asset('PortfolioThemes/images/img-5.png')}}" alt="" class="image">
                           <div class="overlay">
                              <div class="text">
                                 <div class="btn_main">
                                    <div class="buy_bt"><a href="#">See More</a></div>
      ...
      <script src="{{ asset( 'PortfolioThemes/js/bootstrap.bundle.min.js')}}"></script>
      <script src="{{ asset( 'PortfolioThemes/js/jquery-3.0.0.min.js')}}"></script>
      <script src="{{ asset( 'PortfolioThemes/js/plugin.js')}}"></script>
      <script src="{{ asset( 'PortfolioThemes/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
      <script src="{{ asset( 'PortfolioThemes/js/custom.js')}}"></script>
      <script>
         $('#myCarousel').carousel({
            interval: false
         });
