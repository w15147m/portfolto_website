            ...
            <div class="bg-light-card dark:bg-dark-card rounded-2xl shadow-xl overflow-hidden scroll-animate fade-in-up">
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div class="p-8 lg:p-12 bg-gradient-to-br from-primary to-secondary text-white">
                        <h2 class="text-3xl font-bold mb-8 scroll-animate fade-in-down">Let's Connect</h2>
                        <p class="mb-8 text-gray-100 scroll-animate fade-in-up" style="transition-delay: 0.1s">
                            Ready to start your next project? I'm here to help turn your vision into reality.
                        </p>
                        
                        <div class="space-y-6">
                            <div class="flex items-center space-x-4 scroll-animate fade-in-up" style="transition-delay: 0.2s">
                            ...
                            <div class="flex items-center space-x-4 scroll-animate fade-in-up" style="transition-delay: 0.3s">
                                <div class="bg-white/20 p-3 rounded-lg">
                            ...
                            <div class="flex items-center space-x-4 scroll-animate fade-in-up" style="transition-delay: 0.4s">
                                <div class="bg-white/20 p-3 rounded-lg">
                        ...
                        <div class="mt-12 scroll-animate fade-in-up" style="transition-delay: 0.5s">
                    ...
                    <div class="p-8 lg:p-12 bg-light-card dark:bg-dark-card">
                        <h2 class="text-3xl font-bold mb-8 text-gray-900 dark:text-white scroll-animate fade-in-down">Send a Message</h2>
                        <form class="space-y-6">
                            ...
                            <div class="scroll-animate fade-in-up" style="transition-delay: 0.4s">
                            ...
                            <div class="scroll-animate fade-in-up" style="transition-delay: 0.5s">
                            ...
                            <div class="scroll-animate fade-in-up" style="transition-delay: 0.6s">
                            ...
                            <button type="submit" class="w-full py-3 bg-gradient-to-r from-primary to-secondary text-white rounded-lg hover:opacity-90 transition-opacity scroll-animate fade-in-up" style="transition-delay: 0.7s">
                                Send Message
                            </button>
                        </form>
                    </div>
...
<style>
    /* Scroll animation styles for contact section */
    .scroll-animate {
        opacity: 0;
